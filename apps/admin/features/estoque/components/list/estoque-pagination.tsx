...
import { ESTOQUE_PAGE_SIZES } from '../../lib/estoque-helpers'
    ...
    <div className="flex flex-col items-center gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
      <div className="flex flex-wrap items-center justify-center gap-2 text-sm text-muted-foreground sm:justify-start">
        ...
        <Select
          ...
          onValueChange={(value) => setParams({ pageSize: value, page: null })}
        >
          <SelectTrigger className="h-8 w-[4.5rem]">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            {ESTOQUE_PAGE_SIZES.map((size) => (
